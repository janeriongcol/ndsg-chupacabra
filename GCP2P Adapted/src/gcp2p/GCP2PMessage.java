...
public class GCP2PMessage extends SimpleMessage{
	/**
	*	Message TYPES
	*/
	...
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, int data0, int data) 
	{
	...
	public GCP2PMessage (int typeOfMsg, Node sender, Node receiver, LinkedList<ClientInterface> clients, int size){
		super(typeOfMsg, sender, receiver, size);
		this.clients = clients;
	}
	//UPDATE_SP
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node node1, Node node2) 
	{
		super(typeOfMsg, sender, receiver, size);
		this.node1     = node1;
		this.node2 = node2;
	...
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size,Node[] nodeList)
	{
		super(typeOfMsg, sender, receiver, size);
	...
	// YOUR_PEERS
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node[] nodeList, int data)
	{
		super(typeOfMsg, sender, receiver, size);
		this.nodeList = nodeList;
		this.data 		= data;
	}
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, LinkedList<Node> linkedNodeList)
	{
		super(typeOfMsg, sender, receiver, size);
	...
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node superPeer) 
	{
		super(typeOfMsg, sender, receiver, size);
	...
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, int data) 
	{
		super(typeOfMsg, sender, receiver, size);
		this.data = data;
	}
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node[] nodeList, int[] peerWatching)
	{
		super(typeOfMsg, sender, receiver, size);
		this.nodeList = nodeList;
	...
	//YOUR_CLIENTS
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node[] nodeList, int[] peerWatching, int[][] index) 
	{
		super(typeOfMsg, sender, receiver, size);
		this.nodeList = nodeList;
		this.peerWatching = peerWatching;
	...
	//YOUR_CLIENTS
	public GCP2PMessage(int typeOfMsg, Node sender, Node receiver, int size, Node[] nodeList, int[] peerWatching, int[][] index, int data) 
	{
		super(typeOfMsg, sender, receiver, size);
		this.nodeList = nodeList;
		this.peerWatching = peerWatching;
